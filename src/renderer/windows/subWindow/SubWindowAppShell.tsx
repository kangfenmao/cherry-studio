...
export const SubWindowAppShell = () => {
  ...
  return (
    // SubWindow is frameless on every platform, so the renderer title bar is the only drag
    // region / control surface — always render it. Once the chat/agent ConversationShell
    // (which folds this chrome into its own navbar) is carved, page-titled routes can gate
    // it off again.
