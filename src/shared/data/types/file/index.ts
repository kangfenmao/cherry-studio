...
// FILE_TYPE / FileType / FileTypeSchema live in `@shared/types/file`. Re-export
// from this namespace too because dozens of pre-existing v2 consumers (in
// fileProcessing, knowledge, file-processing jobs, …) import them via
...
// module directly.
export { FILE_TYPE, type FileType, FileTypeSchema } from '@shared/types/file'
