...
export const openrouterReasoningFeature: RequestFeature = {
  name: 'openrouter-reasoning',
  applies: (scope) => scope.provider.id === SystemProviderIds.openrouter,
  contributeModelAdapters: () => [createOpenrouterReasoningPlugin()]
}
