...
| 6   | `src/shared/data/types/file/file.ts:28` + `src/renderer/src/types/file.ts:127` | `FileMetadata.purpose?` 字段移除                                                                        |
...
| C2  | `src/shared/data/types/file/file.ts`, `src/renderer/src/types/file.ts` | `FileMetadata.count` 字段删除                                                                  |
...
| #   | 文件                                                                        | 改动                                                                    |
| --- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| E1  | `src/shared/data/types/file/file.ts`, `src/renderer/src/types/file.ts` | FileMetadata 的 `name` / `origin_name` 删除（Cleanup Batch）                  |
...
| #   | 文件                                                                               | 改动                                                                                                           |
| --- | ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| C1  | `src/shared/data/types/file/file.ts:25`, `src/renderer/src/types/file.ts:116` | `FileMetadata.created_at: string` → `number`（或保留 string，v2 新 FileEntry 自己用 number；Cleanup Batch 删旧字段） |
